  ...
  return (
    <section ref={sectionRef} className="relative h-screen overflow-hidden bg-[#FAFAF9]">
      {/* ═══════════════════════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════════════════════ */}
      <div className="relative z-20 flex flex-col items-center justify-center text-center px-6 pt-24 md:pt-28 lg:pt-32 pb-4 min-h-[65vh]">
        {/* Save the date */}
        <motion.p
        ...
        {/* Countdown */}
        <div className="md:bg-background/60 md:backdrop-blur-sm rounded-2xl px-6 py-4">
          <Countdown />
        </div>
